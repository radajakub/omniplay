...
class ModifiedTicTacToePromptAdapter(PromptAdapter):
    def __init__(self) -> None:
        super().__init__(head_prompt_template=MODIFIED_TIC_TAC_TOE_HEAD_PROMPT,
...
class ModifiedTicTacToeEngine(TurnBasedEngine):
    def __init__(self, game_config: GameConfig) -> None:
        super().__init__(game_config, ModifiedTicTacToeGame(), ModifiedTicTacToeTransformer(),
                         ModifiedTicTacToePromptAdapter(), TicTacToeAction, TicTacToeObservation)
