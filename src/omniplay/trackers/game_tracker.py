...
class GameStep(Serializable):
    ...
    def __init__(self, seq: int, player_name: str, player_hash: str, serialized_state: str, observation: str, move: str, input_tokens: int | None = None, output_tokens: int | None = None, reasoning_tokens: int | None = None, data: dict[str, Any] | None = None) -> None:
...
class GameTracker(Serializable):
    ...
    def __init__(self, game_round: int, i_player: PlayerConfig, o_player: PlayerConfig, instance_params: dict[str, Any], steps: list[GameStep] | None = None, ending: GameEnding | None = None, seq: int = 0, other_params: dict[str, Any] | None = None) -> None:
