...
_REQUIRED_METRIC_KEYS = {
    'n_games', 'win_rate', 'draw_rate', 'loss_rate', 'fail_rate', 'player_moves_per_game',
    'input_tokens_per_game', 'output_tokens_per_game', 'input_tokens_per_move', 'output_tokens_per_move',
...
def test_step_translation_unfolds_data_to_flat_fields():
    ...
    step = GameStep(
        1, i.to_string(), i.hash, 'STATE', 'OBS', '<C2R2>',
